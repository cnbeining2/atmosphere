...
class InstanceSerializer(serializers.ModelSerializer):
    ...
    application_name = serializers.CharField(read_only=True, source='provider_machine.application.name')
    application_uuid = serializers.CharField(read_only=True, source='provider_machine.application.uuid')
    ...
    tags = TagRelatedField(slug_field='name', many=True, read_only=True)
    ...
    class Meta:
        model = Instance
        exclude = ('id', 'provider_machine', 'provider_alias', 'shell', 'vnc', 'password', 'created_by_identity')
        # include = ('alias',)
