...
#
    ...
    # url(identity_specific + r'/hypervisor/(?P<hypervisor_id>\d+)$', HypervisorDetail.as_view(), name='hypervisor-detail'),
    #
    ...
    # url(identity_specific + r'/machine/(?P<machine_id>[a-zA-Z0-9-]+)/vote$', MachineVote.as_view(), name='machine-vote'),
    #
...
public_apis = format_suffix_patterns(patterns(
    ...
    # url(identity_specific + r'/instance/' + '(?P<instance_id>[a-zA-Z0-9-]+)/tag/(?P<tag_slug>.*)$', InstanceTagDetail.as_view(), name='instance-tag-detail'),
    # url(identity_specific + r'/instance/' + '(?P<instance_id>[a-za-z0-9-]+)/action$', InstanceAction.as_view(), name='instance-action'),


    url(identity_specific + r'/instance/(?P<instance_id>[a-zA-Z0-9-]+)$', Instance.as_view(), name='instance-detail'),
    ...
    # url(identity_specific + r'/boot_volume(?P<volume_id>[a-zA-Z0-9-]+)?$', BootVolume.as_view(), name='boot-volume'),


    # url(identity_specific + r'/volume_snapshot$', VolumeSnapshot.as_view(), name='volume-snapshot'),
    # url(identity_specific + r'/volume_snapshot/(?P<snapshot_id>[a-zA-Z0-9-]+)$', VolumeSnapshotDetail.as_view(), name='volume-snapshot-detail'),
    ...
    # url(identity_specific + r'/machine/(?P<machine_id>[a-zA-Z0-9-]+)' + '/icon$', MachineIcon.as_view(), name='machine-icon'),
    ...
    # url(identity_specific + r'/request_image/(?P<machine_request_id>\d+)$', MachineRequest.as_view(), name='machine-request'),
