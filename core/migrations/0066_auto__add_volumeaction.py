...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'VolumeAction'
        db.create_table('volume_action', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=50)),
            ('description', self.gf('django.db.models.fields.TextField')()),
        ))
        db.send_create_signal('core', ['VolumeAction'])


    def backwards(self, orm):
        # Deleting model 'VolumeAction'
        db.delete_table('volume_action')
    ...
    models = {
        ...
        'core.flow': {
            ...
            'start_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 1, 25, 0, 0)'}),
        ...
        'core.volumeaction': {
            'Meta': {'object_name': 'VolumeAction', 'db_table': "'volume_action'"},
            'description': ('django.db.models.fields.TextField', [], {}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '50'})
        },
